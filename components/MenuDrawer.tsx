import { User, Sun, Moon, Link as LinkIcon, Save, Check, Copy, ExternalLink, Palette, Download, Upload, Camera, Share, PlusSquare, LogOut, X } from 'lucide-react';
...
export function MenuDrawer({ isOpen, onClose, settings }: MenuDrawerProps) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-zinc-50 dark:bg-black z-[70] shadow-2xl overflow-y-auto"
          >
            <div className="p-6">
